    ...
    <div>
        ...
        <div className='flex flex-col md:flex-row text-sm mb-20'>
            <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
             ...
             <p className='text-gray-600'>At Forever, we stand out by offering more than just clothes—we deliver style, quality, and an exceptional shopping experience</p>
            </div>
            <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
             <b>Convinience:</b>
